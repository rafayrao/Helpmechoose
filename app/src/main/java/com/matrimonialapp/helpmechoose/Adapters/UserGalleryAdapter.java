...
public class UserGalleryAdapter extends RecyclerView.Adapter<UserGalleryAdapter.ViewHoder> {

    Context context;
    List<UsergalleryimageModel> listitem;
    public UserGalleryAdapter(Context context, List<UsergalleryimageModel> listitem){
